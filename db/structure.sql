...
CREATE TABLE IF NOT EXISTS `clienti` (
  `id` VARCHAR(36)  ,
  `id_agente` VARCHAR(36) DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `prodotti` (
  ...
  `id_catalogo` VARCHAR(36) DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `prodotti_giacenze` (
  `id` VARCHAR(36)  ,
  `id_prodotto` VARCHAR(36) NOT NULL,
  `id_deposito` VARCHAR(36) NOT NULL,
